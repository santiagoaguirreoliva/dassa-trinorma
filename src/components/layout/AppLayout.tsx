...
export default function AppLayout() {
  ...
  return (
    <div style={{ display: 'flex', height: '100vh', background: DS.bg, overflow: 'hidden' }}>
      {/* SIDEBAR */}
      <div style={{
        width: 240, flexShrink: 0, background: DS.sidebar,
        ...
        <div style={{ padding: '22px 20px 18px', borderBottom: `1px solid ${DS.sidebarBorder}` }}>
          ...
          <div style={{ marginTop: 12, padding: '5px 10px', background: '#0ea5e915', borderRadius: 6, fontSize: 10, color: '#38bdf8', fontWeight: 600, letterSpacing: '0.04em' }}>
        ...
        <div style={{ flex: 1, padding: '12px 10px' }}>
          {NAV.map(group => (
            <div key={group.group} style={{ marginBottom: 4 }}>
              <button
                onClick={() => setExpanded(e => ({ ...e, [group.group]: !e[group.group] }))}
                style={{
                  width: '100%', padding: '7px 10px', display: 'flex', alignItems: 'center',
                  gap: 8, background: 'none', border: 'none', cursor: 'pointer',
                  color: DS.sidebarText, fontSize: 10, fontWeight: 700,
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      background: active ? DS.sidebarActive : 'none',
                      border: 'none', cursor: 'pointer', borderRadius: 7,
                      color: active ? '#fff' : DS.sidebarText,
        ...
        <div style={{ padding: '14px', borderTop: `1px solid ${DS.sidebarBorder}`, display: 'flex', alignItems: 'center', gap: 10 }}>
          ...
          <div style={{ flex: 1, minWidth: 0 }}>
            <div style={{ fontSize: 12, fontWeight: 600, color: DS.sidebarTextActive, whiteSpace: 'nowrap', overflow: 'hidden', textOverflow: 'ellipsis' }}>
          ...
          <button
            ...
            style={{
              ...
              color: DS.sidebarText, fontSize: 14, padding: 4, borderRadius: 4,
            }}
          >X</button>
        </div>
      </div>
      ...
      <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden' }}>
        {/* Header */}
        <div style={{
          height: 64, background: DS.card, borderBottom: `1px solid ${DS.border}`,
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            <div style={{ fontSize: 11, color: DS.textMuted, textTransform: 'capitalize' }}>{now}</div>
            <div style={{
              padding: '6px 12px', borderRadius: 8, background: DS.dangerLight,
              color: DS.danger, fontSize: 12, fontWeight: 600, cursor: 'pointer',
            }}>[!] 3 alertas</div>
          </div>
        </div>
