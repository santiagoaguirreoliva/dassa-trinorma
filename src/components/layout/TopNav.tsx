    ...
    <header className="h-14 md:h-16 flex-shrink-0 bg-dassa-red flex items-center justify-between px-2 md:px-4 shadow-lg z-50">
      ...
      <div className="flex items-center gap-1 md:gap-3">
        ...
        <button
          ...
          className="flex items-center gap-2 hover:opacity-90 active:opacity-70 transition-opacity touch-manipulation"
        >
          <span className="font-['Montserrat_Alternates',Montserrat,sans-serif] font-black text-[20px] md:text-[22px] text-white tracking-tight leading-none">
            DASSA
          </span>
          <span className="text-white/50 text-lg font-light">·</span>
          <span className="text-white/70 text-[11px] font-semibold tracking-[0.12em] uppercase">
            SGI
          </span>
        </button>
