    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h3 className="text-[15px] font-extrabold text-slate-900">{isEdit ? 'Editar Documento' : 'Nuevo Documento'}</h3>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-slate-200 px-4 py-3 flex items-center gap-3 flex-wrap">
              ...
              <span className="ml-auto text-xs text-slate-400">{docs.length} documentos</span>
            </div>
                    ...
                    return (
                      <tr key={d.id} className="border-b border-slate-100 hover:bg-slate-50 transition-colors">
                        <td className="px-4 py-3">
                          <code className="text-[10px] font-extrabold text-blue-700">{d.code}</code>
                        </td>
                        <td className="px-4 py-3 max-w-[280px]">
                          <p className="text-xs font-semibold text-slate-800 truncate">{d.title}</p>
                        </td>
                        <td className="px-4 py-3">
                          <span className="text-[10px] text-slate-500">{TYPE_CONFIG[d.type] || d.type}</span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 text-center">
                          <span className="text-xs font-bold text-slate-700">v{d.version}</span>
                        </td>
                        <td className="px-4 py-3">
                        ...
                        <td className="px-4 py-3 hidden lg:table-cell">
                          <span className="text-[10px] text-slate-400">{fmtDate(d.review_date)}</span>
                        </td>
                        <td className="px-4 py-3 hidden lg:table-cell">
