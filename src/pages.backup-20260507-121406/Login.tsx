        ...
        <div className="w-full max-w-[380px]">
          ...
          <div className="md:hidden text-center mb-8">
            <div className="inline-flex items-center justify-center w-12 h-12 bg-dassa-red rounded-xl mb-3">
              <span className="font-['Montserrat_Alternates',Montserrat,sans-serif] font-black text-xl text-white">D</span>
            </div>
            <h1 className="text-xl font-extrabold text-slate-900">DASSA SGI</h1>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              ...
              <input
                ...
                className="w-full px-3.5 py-2.5 border border-slate-200 rounded-lg text-slate-800 text-[13.5px] placeholder-slate-400 focus:outline-none focus:border-dassa-red focus:ring-2 focus:ring-dassa-red/10 transition-colors font-sans"
              />
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full px-3.5 py-2.5 pr-10 border border-slate-200 rounded-lg text-slate-800 text-[13.5px] placeholder-slate-400 focus:outline-none focus:border-dassa-red focus:ring-2 focus:ring-dassa-red/10 transition-colors font-sans"
                />
                <button
                  type="button"
          ...
          <p className="text-center text-[11px] text-slate-400 mt-8 font-secondary">
