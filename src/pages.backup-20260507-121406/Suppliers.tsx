    ...
    <div className="fixed inset-0 bg-black/60 z-50 flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg" onClick={e => e.stopPropagation()}>
        <div className="flex items-center justify-between px-6 py-4 border-b">
          <h3 className="text-[15px] font-extrabold text-slate-900">{isEdit ? 'Editar Proveedor' : 'Nuevo Proveedor'}</h3>
        ...
        {isLoading ? (
          ...
          <div className="space-y-4">
            ...
            <div className="bg-white rounded-xl border border-slate-200 px-4 py-3 flex items-center gap-3 flex-wrap">
              ...
              <span className="ml-auto text-xs text-slate-400">{suppliers.length} proveedores</span>
            </div>
                        ...
                        <td className="px-4 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            <div>
                              ...
                              {s.contact_name && <p className="text-[10px] text-slate-400">{s.contact_name}</p>}
                            </div>
                          </div>
                        </td>
                        <td className="px-4 py-3 hidden md:table-cell">
                          <span className="text-[10px] text-slate-500 font-mono">{s.cuit || '—'}</span>
                        </td>
                        <td className="px-4 py-3 hidden md:table-cell">
                          <span className="text-[10px] text-slate-500">{TYPE_LABELS[s.type ?? ''] || s.type || '—'}</span>
                        </td>
