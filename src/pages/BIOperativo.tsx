    ...
    <PageContent>
      ...
      <div className="bg-white border border-gray-200 rounded-xl p-4 mb-4 flex items-center justify-between">
        <div className="text-xs text-gray-600">
          BI compartido por todo el ecosistema DASSA: Trinorma · Depofis · Marketing · Tally · etc. Conectar a la DB <code className="bg-gray-100 px-1.5 py-0.5 rounded">dassa_sgi</code> en el primer login.
          {isAdmin && <span className="ml-2 text-dassa-celeste-deep font-bold">Sos admin · podés crear dashboards.</span>}
        </div>
        <a href="/bi/" target="_blank" rel="noreferrer" className="flex items-center gap-1 px-3 py-1.5 bg-dassa-celeste-deep text-white text-xs font-bold rounded-lg hover:bg-dassa-celeste">
      ...
      <div className="bg-white border border-gray-200 rounded-xl overflow-hidden" style={{ height: 'calc(100vh - 280px)', minHeight: 500 }}>
        <iframe src="/bi/" className="w-full h-full" title="Metabase BI Operativo" frameBorder="0"/>
      </div>
    </PageContent>
  );
}
