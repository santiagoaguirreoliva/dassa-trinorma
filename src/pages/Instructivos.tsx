...
export default function Instructivos() {
  ...
  return (
    <PageContent>
      <Header title="📲 Instructivos de la app" subtitle={`${data.procedures.length} instructivos de uso de la aplicación · cómo operar cada módulo`} icon={<BookOpen size={20}/>}/>
      {/* Charts */}
