  ...
  return (
    <div className="flex-1 overflow-y-auto bg-slate-50">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-black text-gray-900 flex items-center gap-2">
              <Megaphone className="w-8 h-8 text-[#BF1E2E]" />
              Novedades del sistema
            </h1>
            <p className="text-gray-600 mt-1">Anuncios que ven todos los users en su Bienvenida.</p>
          </div>
          <button onClick={newItem} className="flex items-center gap-2 bg-[#BF1E2E] hover:bg-[#a01825] text-white font-bold rounded-lg px-4 py-2.5">
        ...
        {editing && (
          <div className="bg-white rounded-xl border-2 border-[#BF1E2E] p-6 mb-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
              <div>
                ...
                <input type="text" value={editing.title || ''} onChange={e => setEditing({ ...editing, title: e.target.value })} className="w-full border border-gray-300 rounded-lg px-3 py-2 focus:border-[#BF1E2E] focus:ring-1 focus:ring-[#BF1E2E] outline-none" placeholder="🚀 Nueva función disponible" />
              </div>
              <div>
            ...
            <div className="flex gap-2">
              <button onClick={save} disabled={saving} className="flex-1 bg-[#BF1E2E] hover:bg-[#a01825] disabled:bg-gray-300 text-white font-bold py-2.5 rounded-lg flex items-center justify-center gap-2">
