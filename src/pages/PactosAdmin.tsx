        ...
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-3xl font-black text-gray-900 flex items-center gap-2">
              <UsersIcon className="w-8 h-8 text-[#BF1E2E]" />
              Pactos Trinorma
            </h1>
                  ...
                  <tr key={r.id} className="border-t border-gray-100 hover:bg-gray-50">
                    ...
                    <td className="px-4 py-3">
                      <div className="flex gap-2">
                        {canSendEmails && (
                          <button onClick={() => sendEmail(r.email)} disabled={sending === r.email} className="text-xs bg-[#BF1E2E] hover:bg-[#a01825] disabled:bg-gray-300 text-white px-3 py-1.5 rounded font-medium inline-flex items-center gap-1">
